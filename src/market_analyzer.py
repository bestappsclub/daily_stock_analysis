...
class MarketAnalyzer:
    ...
    def __init__(
        ...
        self.region = region if region in ("cn", "us", "hk", "sg") else "cn"
    ...
    def _get_market_scope_name(self, review_language: str | None = None) -> str:
        ...
        if self.region == "sg":
            return "Singapore market" if review_language == "en" else "新加坡市场"
    ...
    def _get_turnover_unit_label(self) -> str:
        ...
        if self.region == "sg":
            return "SGD bn" if self._get_review_language() == "en" else "十亿新元"
    ...
    def _get_review_title(self, date: str) -> str:
        if self._get_review_language() == "en":
            market_names = {"us": "US Market Recap", "hk": "HK Market Recap", "sg": "SG Market Recap"}
    ...
    def _get_index_hint(self) -> str:
        if self._get_review_language() == "en":
            ...
            if self.region == "sg":
                return "Analyze the key moves in the Straits Times Index (STI) and other major Singapore indices."
