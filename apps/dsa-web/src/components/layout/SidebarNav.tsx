...
import { BarChart3, Bell, BriefcaseBusiness, GraduationCap, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'learn', label: '学习', to: '/learn', icon: GraduationCap },
